...
public class CatalogsProductsServlet extends HttpServlet {
	...
	private static final String USER_CATALOG = "catalogs/get-user-catalogs";
	private static final String CATALOGS = "catalogs/get";
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
			requestURL2 = PLATFORM_URL + "/" + USER_CATALOG + "?userId=" + user_id +
        ...
        //resp.getWriter().println("catalogs " + result);
        
        result = result.substring(1, result.length()-1);
        
        String requestURL3 = null;
        try {
			requestURL3 = PLATFORM_URL + "/" + CATALOGS + "?ids=" + result +
					"&token=" + sessionToken + "&hash=" + getHash();
		} catch (Exception e) {
			e.printStackTrace();
		}
